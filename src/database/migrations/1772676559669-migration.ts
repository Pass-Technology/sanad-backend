...
export class Migration1772676559669 implements MigrationInterface {
    name = 'Migration1772676559669'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_2e7b7debda55e0e7280dc93663d"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "identifier"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "identifierType"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "mobile" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "identifierType" "public"."users_identifiertype_enum" NOT NULL`);
        await queryRunner.query(`ALTER TABLE "users" ADD "identifier" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_2e7b7debda55e0e7280dc93663d" UNIQUE ("identifier")`);
