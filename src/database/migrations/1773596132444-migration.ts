...
export class Migration1773596132444 implements MigrationInterface {
    name = 'Migration1773596132444'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "provider_profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "trade_name" character varying, "company_representative_name" character varying, "company_description" text, "social_media_link" character varying, "website_link" character varying, "languages_spoken" text, "selected_service_ids" text, "current_step" integer NOT NULL DEFAULT '1', "status_id" uuid, "provider_type_id" uuid, "companyTypeId" uuid, "user_id" uuid, CONSTRAINT "PK_0197ced76e32133df96a97168df" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "otps" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "identifier" character varying NOT NULL, "otp" character varying NOT NULL, "is_verified" boolean NOT NULL DEFAULT false, "expires_at" TIMESTAMP NOT NULL, "user_id" uuid, CONSTRAINT "PK_91fef5ed60605b854a2115d2410" PRIMARY KEY ("id"))`);
