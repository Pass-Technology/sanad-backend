...
export class Migration1773185538536 implements MigrationInterface {
    name = 'Migration1773185538536'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "lookup_billing_cycle" ADD "months" integer NOT NULL`);
