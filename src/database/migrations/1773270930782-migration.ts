...
export class Migration1773270930782 implements MigrationInterface {
    name = 'Migration1773270930782'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "serving_areas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "radius_km" numeric NOT NULL, "phone" character varying, "map_link" character varying, "lat" numeric, "lng" numeric, "branch_id" uuid, CONSTRAINT "PK_1bcde14eea84f7f427e5ec91059" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "branches" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "branch_name" character varying NOT NULL, "branch_manager_name" character varying NOT NULL, "branch_address" character varying NOT NULL, "city" character varying NOT NULL, "branch_phone" character varying, "manager_phone" character varying, "google_maps_link" character varying, "social_media_link" character varying, "provider_profile_id" uuid, CONSTRAINT "PK_7f37d3b42defea97f1df0d19535" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "provider_profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "trade_name" character varying, "company_representative_name" character varying, "company_description" text, "social_media_link" character varying, "website_link" character varying, "languages_spoken" text, "selected_service_ids" text, "current_step" integer NOT NULL DEFAULT '1', "status_id" uuid, "provider_type_id" uuid, "company_type_id" uuid, "user_id" uuid, CONSTRAINT "PK_0197ced76e32133df96a97168df" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "subscription_plans" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "monthly_price" numeric NOT NULL, "booking_limit" integer, "commission_percent" numeric, "is_most_popular" boolean NOT NULL DEFAULT false, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_9ab8fe6918451ab3d0a4fb6bb0c" PRIMARY KEY ("id"))`);
