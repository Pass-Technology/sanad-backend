...
export class Migration1773185098244 implements MigrationInterface {
    name = 'Migration1773185098244'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "lookup_billing_cycle" ADD "months" integer NOT NULL DEFAULT 1`);
