...
export class Migration1773185252692 implements MigrationInterface {
    name = 'Migration1773185252692'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "lookup_billing_cycle" ADD "discountPercent" integer DEFAULT '0'`);
