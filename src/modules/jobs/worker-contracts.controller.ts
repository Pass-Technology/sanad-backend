import { Controller, Get, Patch, Post, Body, Param, UseGuards, Query, Request } from '@nestjs/common';
...
export class WorkerContractsController {
    ...
    addContractAssets(
        ...
        return this.jobsService.addContractAssets(req.user.userId, id, dto);
    }
